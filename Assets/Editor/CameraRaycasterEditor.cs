...
public class CameraRaycasterEditor : Editor {
    ...
    {
        serializedObject.Update(); // Serialize cameraRaycaster instance --->> 1)
        ...
        serializedObject.ApplyModifiedProperties(); // De-serialize back to cameraRaycaster (and create undo point) --->> 2)
    }
